...
//return a pointer to the color of the tile if it is monochrome else return NULL
...
//return the score if the tile (x,y) is part of a pattern, testing all the patterns from the most important to the less important
